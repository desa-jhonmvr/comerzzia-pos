 ...
 */
@Embeddable
public class RecuentoCajaDetPK implements Serializable {
    ...
    public RecuentoCajaDetPK() {
    }

    public RecuentoCajaDetPK(String uidCajeroCaja,int linea) {
        this.linea = linea;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RecuentoCajaDetPK)) {
            return false;
        }
        RecuentoCajaDetPK other = (RecuentoCajaDetPK) object;
    ...
    public String toString() {
        return "entity.db.RecuentoCajaDetPK[ linea=" + linea + ", uidCajeroCaja=" + uidCajeroCaja + " ]";
    }
