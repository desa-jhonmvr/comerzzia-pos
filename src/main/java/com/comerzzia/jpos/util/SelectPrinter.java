...
public class SelectPrinter extends javax.swing.JDialog {
	...
	public static SelectPrinter getSelectPrinter(Component parent,
			String[] printers) {
	...
	private void initComponents() {
		...
		jLabel7.setText("Label MachinePrinter");
		...
		java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit()
				.getScreenSize();
		setBounds((screenSize.width - 359) / 2, (screenSize.height - 176) / 2,
				359, 176);
