...
public class GiftCardNotFoundException extends Exception {
	...
	public GiftCardNotFoundException(String msg, Throwable e) {
		super(msg, e);
	}

	public GiftCardNotFoundException(String msg, String msgKey) {
		super(msg, msgKey);
	}

	public GiftCardNotFoundException(String msg, String msgKey, Throwable e) {
		super(msg, msgKey, e);
	}
}
