...
public class GiftCardException extends Exception {
	...
	public GiftCardException(String msg) {
		super(msg);
	}

	public GiftCardException(String msg, Throwable e) {
		super(msg, e);
	}

	public GiftCardException(String msg, String msgKey, Throwable e) {
		super(msg, msgKey, e);
	}

	public GiftCardException(String msg, String msgKey) {
		super(msg, msgKey);
	}
}
