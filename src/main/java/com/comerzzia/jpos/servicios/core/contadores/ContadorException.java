...
public class ContadorException extends Exception {
	...
	public ContadorException(String msg) {
		super(msg);
	}

	public ContadorException(String msg, Throwable e) {
		super(msg, e);
	}

	public ContadorException(String msg, String msgKey) {
		super(msg, msgKey);
	}

	public ContadorException(String msg, String msgKey, Throwable e) {
		super(msg, msgKey, e);
	}
}
