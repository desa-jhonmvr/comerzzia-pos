...
public class PermisoException extends Exception {
    ...
    public PermisoException(String msg) {
        super(msg);
    }

    public PermisoException(String msg, Throwable e) {
        super(msg, e);
    }

    public PermisoException(String msg, String msgKey) {
        super(msg, msgKey);
    }

    public PermisoException(String msg, String msgKey, Throwable e) {
        super(msg, msgKey, e);
    }
}
