...
public class PermisosEfectivosAccionBean implements Serializable {
    ...
    private Long accionMenu;
    private Long idUsuario;
    private Long idPerfil;
    private String desUsuario;
    private String desPerfil;
    private Map<Byte, PermisoBean> permisos;

    /**
     * Constructor
     */
    public PermisosEfectivosAccionBean() {
        permisos = new HashMap<Byte, PermisoBean>();
    }
     ...
     * @param idUsuario
     */
    public PermisosEfectivosAccionBean(Long accionMenu, Long idUsuario) {
     ...
     */
    public void setAccionMenu(Long accionMenu) {
        this.accionMenu = accionMenu;
    }
    ...
    public void setListaPermisos(List<PermisoBean> permisos) {
        for (PermisoBean permiso : permisos) {
            this.permisos.put(permiso.getOperacion().getIdOperacion(), permiso);
        }
    }
     ...
     */
    public boolean isPuede(Byte operacion) {
     ...
     */
    public boolean isPuedeAdministrar(Byte operacion) {
        // Obtenemos los permisos para la operacion
        PermisoBean permiso = permisos.get(operacion);
        if (permiso == null) {
            return false;
    ...
    public boolean isConcedido(Byte operacion) {
        // Obtenemos los permisos para la operacion
        PermisoBean permiso = permisos.get(operacion);
        if (permiso == null) {
            return false;
    ...
    public boolean isPuedeEjecutar() {
        return isPuede(new Integer(0).byteValue());
    }
     ...
     */
    public Map<Byte, PermisoBean> getPermisos() {
        return permisos;
    }
