...
public class ArticuloException extends Exception {
    ...
    public ArticuloException(String msg, Throwable e) {
        super(msg, e);
    }

    public ArticuloException(String msg, String msgKey) {
        super(msg, msgKey);
    }

    public ArticuloException(String msg, String msgKey, Throwable e) {
        super(msg, msgKey, e);
    }
}
