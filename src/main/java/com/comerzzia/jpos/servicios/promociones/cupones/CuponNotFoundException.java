...
public class CuponNotFoundException extends Exception {
	...
	public CuponNotFoundException(String msg) {
		super(msg);
	}
	
	public CuponNotFoundException(String msg, Throwable e) {
        super(msg, e);
    }

	public CuponNotFoundException(String msg, String msgKey, Throwable e) {
		super(msg, msgKey, e);
	}

	public CuponNotFoundException(String msg, String msgKey) {
		super(msg, msgKey);
	}
}
