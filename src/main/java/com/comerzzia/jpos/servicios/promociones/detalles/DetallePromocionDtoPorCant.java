...
public class DetallePromocionDtoPorCant extends DetallePromocion {

    private String codArticulo;
    private String desArticulo;
    private BigDecimal precioTarifa;
    private BigDecimal precioTarifaConImpuestos;
    private Map<Integer, ComboCantidadDtoBean> combos;
    ...
    public DetallePromocionDtoPorCant(){
    }
    
    public void setCombos(List<ComboCantidadDtoBean> combos){
        this.combos = new HashMap<Integer, ComboCantidadDtoBean> ();
        if (combos == null || combos.isEmpty()){
            ...
            ComboCantidadDtoBean comboActual = null;
            int cantActual = cantComboMenor;
            for (ComboCantidadDtoBean combo : combos) {
    ...
    public ComboCantidadDtoBean getComboOptimo(int cantidad){
    ...
    private ComboCantidadDtoBean getCombo(int cantidad){
    ...
    private BigDecimal calculaComboOptimo(int cantidad){
        ...
        while (cantCandidata >= cantComboMenor){
        	dtoCandidato = getCombo(cantCandidata).getDescuento().multiply(new BigDecimal(cantCandidata));
