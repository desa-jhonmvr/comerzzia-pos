 ...
 * @author MGRI
 */
public class ArticulosPlanesNoviosCellRenderer implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable jtable, Object object, boolean isSelected, boolean hasFocus, int row, int col) {
        ...
        if (col == 0) {
            ...
            etiqueta.setText(" " + articulo.getCodArt());
        }
            ...
            if ((articulo.isComprado() || articulo.isPendienteEnvio() || articulo.isPendienteRecoger()) && articulo.getInvitadoPlanNovio()!=null){
                etiqueta.setText(articulo.getInvitadoPlanNovio().getNombre()+" "+articulo.getInvitadoPlanNovio().getApellido());          
            }
            else if ((articulo.isComprado() || articulo.isPendienteEnvio() || articulo.isPendienteRecoger()) && articulo.getInvitadoPlanNovio()==null ){
                etiqueta.setText("BODA");
            }
            else{
                etiqueta.setText("");
            }
