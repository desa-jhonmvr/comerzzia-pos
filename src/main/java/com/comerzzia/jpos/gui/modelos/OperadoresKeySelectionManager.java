 ...
 * @author MGRI
 */
public class OperadoresKeySelectionManager implements JComboBox.KeySelectionManager {
    ...
    public int selectionForKey(char aKey, ComboBoxModel model) {
        ...
        for (int i = selIx + 1; i < model.getSize(); i++) {
            String s = ((OperadorMovil) model.getElementAt(i)).getDesoperador().toUpperCase();
