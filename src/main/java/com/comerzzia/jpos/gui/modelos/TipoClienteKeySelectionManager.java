 ...
 * @author SMLM
 */
public class TipoClienteKeySelectionManager implements JComboBox.KeySelectionManager {
    ...
    public int selectionForKey(char aKey, ComboBoxModel model) {
        ...
        for (int i = selIx + 1; i < model.getSize(); i++) {
            String s = ((TipoClienteBean) model.getElementAt(i)).getDesTipoCliente().toUpperCase();
