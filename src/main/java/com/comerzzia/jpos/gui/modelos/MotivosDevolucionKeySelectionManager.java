 ...
 * @author MGRI
 */
public class MotivosDevolucionKeySelectionManager implements JComboBox.KeySelectionManager {
    ...
    public int selectionForKey(char aKey, ComboBoxModel model) {
        ...
        for (int i = selIx + 1; i < model.getSize(); i++) {
            String s = ((MotivoDevolucion) model.getElementAt(i)).getDescripcionMotivo().toUpperCase();
