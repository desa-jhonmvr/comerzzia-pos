 ...
 * @author jmc
 */
public class JObservaciones extends JVentanaDialogo implements IViewerValidationFormError{
    
    private String observaciones;
    
    /** Creates new form JObservaciones */
    public JObservaciones() {
    ...
    public void leerObservaciones(){
        t_observaciones.setText(observaciones);
    }
    ...
    private void initComponents() {
        ...
        js_observaciones.setViewportView(t_observaciones);
        ...
        b_cancelar.setNextFocusableComponent(t_observaciones);
        ...
        l_pagos_a_cancelar.setForeground(new java.awt.Color(0, 102, 255));
        l_pagos_a_cancelar.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        l_pagos_a_cancelar.setText("OBSERVACIONES");
    ...
    public void accionAceptar() {
        setObservaciones(parseaXML(t_observaciones.getText()));
        limpiarFormulario();
        cerrarVentana();
    }
