 ...
 * @author MGRI
 */
public class JIngresarGarantia extends JVentanaDialogo implements IViewerValidationFormError {

    private static final Logger log = Logger.getMLogger(JIngresarGarantia.class);
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lb_mensaje, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
  ...
  public void accionAceptar() {
        try {
            ...
            java.util.logging.Logger.getLogger(JIngresarGarantia.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (!t_valor.getText().isEmpty()) {
            ...
            if (usuario != null) {
                ...
                lb_error.setText("Usuario no encontrado");
            }
        } else {
            usuario=null;
    ...
    public void iniciaFoco() {
     ...
     public Usuarios getValor() {
         if(valorS==null || valorS.equals("")){
             usuario=null;
         }
        Object res = null;
