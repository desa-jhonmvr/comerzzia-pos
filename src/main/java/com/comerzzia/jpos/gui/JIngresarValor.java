 ...
 * @author MGRI
 */
public class JIngresarValor extends JVentanaDialogo implements IViewerValidationFormError {

    private static final Logger log = Logger.getMLogger(JIngresarValor.class);
