...
public class TablaAmortizacionDetDTO {
    ...
    public TablaAmortizacionDetDTO(Long numeroCuota, BigDecimal cuotaAPagar, BigDecimal interes, BigDecimal capitalAmortizado, BigDecimal capitalVivo) {
    ...
    public TablaAmortizacionDetDTO() {
    }
    ...
    public static class TablaAmortizacionDetBuilder {
        ...
        public TablaAmortizacionDetDTO build() {
            return new TablaAmortizacionDetDTO(this.numeroCuota, this.cuotaAPagar, this.interes, this.capitalAmortizado, this.capitalVivo);
        }
