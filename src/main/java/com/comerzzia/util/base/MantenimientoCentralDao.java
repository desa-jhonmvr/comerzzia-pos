...
public abstract class MantenimientoCentralDao {
    ...
    protected static String getNombreElementoConfiguracion(String elemento) {
        return Variables.getVariable(Variables.DATABASE_CENTRAL_ESQUEMA_CONFIG) + "." + elemento + " ";
    }
    ...
    protected static String getNombreElementoPasarela(String elemento) {
        return Variables.getVariable(Variables.DATABASE_PASARELA_ESQUEMA) + "." + elemento + " ";
    }
