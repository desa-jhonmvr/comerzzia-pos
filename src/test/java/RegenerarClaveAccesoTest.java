 ...
 */
public class RegenerarClaveAccesoTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            TicketsAlm ticketsAlm = TicketService.consultarTicket(1L, "101", "040");
            ticketsAlm.getTicket();
            
             String ruc = Sesion.getEmpresa().getCif();
            String claveAcceso = ClaveAccesoSri.generaClave(ticketsAlm.getFecha(), EnumTipoComprobante.FACTURA.getCogidoSRI(), ruc, "2",
                    "040" + ticketsAlm.getCodAlm(), String.format("%09d", ticketsAlm.getIdTicket()), Constantes.VALOR_DEFECTO_CLAVE_ACCESO, "1");
